...
- `::Type{T}`: data type
- `n::Int64`: total number of elements in array/matrix data
- `matrix_data::Bool`: boolean keyword to specify matrix or array data
- `c_dim::Int64`: column number of matrix data
...
"""
function read_bin(io::IO,::Type{T},n::Int64,matrix_data::Bool,c_dim::Int64) where T
...
- `c_dim::Int64`: optional column number of matrix data
...
"""
function read_bin(fileName::String;matrix_data=false,c_dim::Int64=1)
    # Open the file
    io=open(fileName,"r")
